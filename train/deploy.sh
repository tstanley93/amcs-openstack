...
openstack overcloud deploy --answers-file /home/stack/templates/answers.yaml -r /home/stack/templates/my_roles_data.yaml -n /home/stack/templates/network_data.yaml --stack ${depName} --ntp-server "time.google.com" --disable-validations --deployed-server --overcloud-ssh-user stack --overcloud-ssh-key /home/stack/.ssh/id_rsa 2>&1 | tee ${depName}_install.log
